...
test_handle_wake_terminal_signal_clears_pause_tracking() {
  ...
  : > "$state/.paused-pr-ready-rechecked-$watcher_key"
  ...
  [ ! -e "$state/.paused-pr-ready-rechecked-$watcher_key" ] || fail "terminal signal retained watcher PR-ready pause tracking"
...
test_housekeeping_migrates_watcher_unpaused_marker_to_clear() {
  ...
  [ ! -e "$state/.paused-pr-ready-rechecked-$watcher_key" ] || fail "stale watcher PR-ready pause marker was not cleared after resume"
